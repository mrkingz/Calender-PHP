...
@section('page-content')
    @schedules(['route' => 'view.pending', 'btn_text' => 'My Schedules'])
        @slot('content')
            <div class="schedules px-2 pt-2">               
                <div class="row">
                    <div class="col-lg-12">
                    ...
                    <div class="col-lg-12">
                        <form class="form mb-2 px-4 inner-wrap" action="{{ route('store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input id="title" type="title" class="form-control form-control-sm {{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" value="{{ $schedule->title }}" placeholder="Title" autocomplete="off" autofocus>
                                @if ($errors->has('title'))
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input id="date" type="text" placeholder="Date e.g. yyyy-mm-dd" class="form-control form-control-sm {{ $errors->has('date') ? ' is-invalid' : '' }}" name="date" value="{{ $schedule->date }}">
                                            @if ($errors->has('date'))
                                                <span class="invalid-feedback" role="alert">
                                                    {{ $errors->first('date') }}
                                                </span>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input id="time" type="text" placeholder="Time e.g. 12:30:00" class="form-control form-control-sm {{ $errors->has('time') ? ' is-invalid' : '' }}" name="time" value="{{ $schedule->time }}">
                                            @if ($errors->has('time'))
                                                <span class="invalid-feedback" role="alert">
                                                    {{ $errors->first('time') }}
                                                </span>
                            ...
                            <div class="form-group">
                                <label class="m-0" for="note"><i class="fa fa-edit"></i> {{ __('Note (Optional)') }}</label>
                                <div class="form-control editable-div {{ $errors->has('note') ? ' is-invalid' : '' }}" id="note" contentEditable="true" placeholder="Any note? Enter it here...">
                                    {{ $schedule->note['note'] }}
                                </div>
                                @if ($errors->has('note'))
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group">
                                ...
                                <a class="btn btn-outline-info btn-sm" href="{{ route('view.pending') }}">
                                    {{ __('Quit') }}
                                </a> 
                            </div>
                        </form>
